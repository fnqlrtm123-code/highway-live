      ...
      <div className="flex flex-col gap-8 text-sm sm:text-base leading-relaxed font-sans">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 mt-2 text-slate-650 flex flex-col gap-1">
            ...
            <li>알뜰주유소 최저가 정보 및 전기차/수소차 충전 현황</li>
        ...
        <section>
          ...
          <ol className="list-decimal pl-5 mt-2 text-slate-650 flex flex-col gap-3">
            <li>
              <strong>데이터의 정확성:</strong> 사이트가 제공하는 CCTV 영상, 유가 정보, 휴게소 편의시설 현황 및 통행 요금 등은 공공 API 데이터 갱신 시점에 따라 실제 도로 현장의 현황과 일치하지 않을 수 있습니다. 본 사이트는 데이터의 즉각적인 정확성, 신뢰성, 완전성을 보증하지 않습니다.
            </li>
            <li>
              <strong>책임의 제한:</strong> 이용자가 본 사이트에 수록된 정보 또는 가격 기재 내용을 신뢰하고 최종 의사결정을 수행함으로써 발생할 수 있는 직·간접적 손해(경유지 오판, 가격 오차, 충전기 미인식 등)에 대해 사이트 운영자는 일체의 책임을 부담하지 않습니다. 실제 도로 이용 시에는 내비게이션 및 현장 안내 표지판을 적극 참고하시기 바랍니다.
            </li>
          </ol>
        </section>
