          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 divide-y md:divide-y-0 divide-slate-100">
            <div className="space-y-5">
              ...
              <div className="pt-4 space-y-1.5">
                ...
                <p className="text-slate-500 text-[11.5px] md:text-xs leading-relaxed pl-4 font-medium">
                  주유소 가격은 수집된 자료를 기준으로 표시하며 실시간 결제 가격과 다를 수 있습니다. 출발 전 한국석유공사 오피넷 또는 해당 주유소에서 최신 가격을 확인해 주세요.
                </p>
              </div>
          ...
          __html: JSON.stringify({
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "주유소 가격은 수집된 자료를 기준으로 표시하며 실시간 결제 가격과 다를 수 있습니다. 출발 전 한국석유공사 오피넷 또는 해당 주유소에서 최신 가격을 확인해 주세요."
                }
              },
              {
                "@type": "Question",
