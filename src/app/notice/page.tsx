...
export default function NoticePage() {
  ...
  const faqs: FAQItem[] = [
    ...
    {
      question: '휴게소의 대표 음식이란 무엇인가요?',
      answer: '대표 음식은 한국도로공사에서 전국 휴게소의 대표 메뉴 중 전문가의 맛 평가와 고객 품평을 거쳐 공식 지정한 최고 수준의 시그니처 메뉴입니다. 각 휴게소 상세 페이지에서 가격과 메뉴 설명을 함께 확인하실 수 있습니다.'
    },
    {
